<script lang="ts">
  ...
  const dados = {
    1: {
      cor: '#2D6E7E',
      cap: 'battute uguali · stessa durata',
...
<div class="tg" style="width: {larg}">
  ...
  {/if}
  <svg viewBox="0 0 240 96" role="img" aria-label={`Gesto ritmico ${gesto}: ${g.cap}`}>
