  ...
  >
    <div class="flex items-center justify-between gap-2">
      <a href="{base}/" class="flex items-baseline gap-1.5">
        <span class="text-lg font-extrabold text-terracota">Bitte?</span>
        <span class="hidden text-xs font-medium text-carvao/50 sm:inline">· Tedesco di sopravvivenza per la Germania</span>
      </a>
        ...
        <div class="relative">
          ...
          {#if menuAberto}
            ...
            >
              ...
              >
                <span class="text-lg">💱</span> Tasca del viaggiatore
              </a>
            </div>
          {/if}
        </div>
